...
void DepthCallback(const std::shared_ptr<CDepthStream> &, const std::shared_ptr<const CImageFrame> &dFrame,
    ...
    *cloud_filtered = *cloud_near + *cloud_far;
    ...
    for (std::vector<pcl::PointIndices>::const_iterator it = cluster_indices.begin();
        ...
        min_u = (fx * curr_bbox.min_point.x / curr_bbox.min_point.z) + cx;
        min_v = (fy * curr_bbox.min_point.y / curr_bbox.min_point.z) + cy;
        max_u = (fx * curr_bbox.max_point.x / curr_bbox.max_point.z) + cx;
        max_v = (fy * curr_bbox.max_point.y / curr_bbox.max_point.z) + cy;
